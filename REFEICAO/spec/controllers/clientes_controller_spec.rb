  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved cliente as @cliente" do
        ...
        post :create, {:cliente => { "DESC_Nome" => "invalid value" }}, valid_session
        assigns(:cliente).should be_a_new(Cliente)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested cliente" do
        ...
        Cliente.any_instance.should_receive(:update).with({ "DESC_Nome" => "MyString" })
        put :update, {:id => cliente.to_param, :cliente => { "DESC_Nome" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the cliente as @cliente" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Cliente.any_instance.stub(:save).and_return(false)
        put :update, {:id => cliente.to_param, :cliente => { "DESC_Nome" => "invalid value" }}, valid_session
        assigns(:cliente).should eq(cliente)
      end
